<?php
    ...
    class Kb extends CI_Controller {
        ...
        public function index($prodi=null,$smt=null,$kelas=null)
        {
            ...
            $data['content'] = 'admin/kb/pemilih_kb';
        ...
        function addKelas(){
            ...
            if($jml==null){
                ...
                redirect('admin/pemilih/kb/','refresh');
            }
            $data = array(
                    'id_prodi' => 'kb',
        ...
        function add_pemilih($prodi=null,$smt=null,$kelas=null){
            if($prodi==null||$smt==null||$kelas==null){
                ...
                redirect('admin/kb/index/'.$prodi.'/'.$smt.'/'.$kelas);
            }		
            ...
            if($this->input->post('submit')){
                if ($this->form_validation->run() == TRUE) {
                    ...
                    if($this->ion_auth->register($username,$password,null,$additional,$group)){
                        ...
                        redirect('admin/kb/add_pemilih/'.$prodi.'/'.$smt.'/'.$kelas);
                    }
                    else{
                    ...
                    $data['kelas']		= $kelas;
                    $data['smt']		= $smt;
                    $data['content']	= 'admin/kb/add_pemilih';
                    $this->load->view('template',$data);
                }
            }
            else{
        ...
        function edit_pemilih($id=null,$prodi=null,$smt=null,$kelas=null){
            ...
            if($users_group){
                ...
                $data['kelas']		= $kelas;
                $data['smt']		= $smt;
                $data['content']	= 'admin/kb/edit_pemilih';
                $this->load->view('template',$data);
            }
            else{
                $this->session->set_flashdata('info', 'Update Failed!');
                redirect('admin/kb/edit_pemilih/'.$id.'/'.$prodi.'/'.$smt.'/'.$kelas);
            }
        }
