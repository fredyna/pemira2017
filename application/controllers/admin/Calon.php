<?php 
    ...
    class Calon extends CI_Controller {
        ...
        public function presma(){
            ...
            $data['content']    = 'admin/calon_presma';
        ...
        public function addCalonPresma(){
            if($this->input->post('submit')==true){
                ...
                if ($this->form_validation->run() == TRUE) {
                    ...
                    $data['content']    = 'admin/calon_presma_add';
                    $this->load->view('template',$data);
                }
        ...
        public function editCalonPresma($id=null){
            ...
            if($this->input->post('submit')==true){
                ...
                if ($this->form_validation->run() == TRUE) {
                    ...
                    $data['content']    = 'admin/calon_presma_edit';
                    $this->load->view('template',$data);
                }
        ...
        public function viewCalonPresma($id=null){
            ...
            $data['content']    = 'admin/calon_presma_view';
            $this->load->view('template',$data);
        }
        ...
        public function kahim(){
            ...
            $data['content']        = 'admin/calon_kahim';
            $this->load->view('template',$data);
        }
        ...
        public function addCalonKahim(){
            if($this->input->post('submit')==true){
                ...
                if ($this->form_validation->run() == TRUE) {
                    ...
                    $data['content']    = 'admin/calon_kahim_add';
                    $this->load->view('template',$data);
                }
        ...
        public function editCalonKahim($id=null){
            ...
            if($this->input->post('submit')==true){
                ...
                if ($this->form_validation->run() == TRUE) {
                    ...
                    $data['content']    = 'admin/calon_kahim_edit';
                    $this->load->view('template',$data);
                }
        ...
        public function viewCalonKahim($id=null){
            ...
            $data['content']    = 'admin/calon_kahim_view';
            $this->load->view('template',$data);
        }
