<?php 
    ...
    class Kom extends CI_Controller {
        ...
        public function index($prodi=null,$smt=null,$kelas=null)
        {
            ...
            $data['content'] = 'admin/kom/pemilih_kom';
        ...
        function addKelas(){
            ...
            if($jml==null){
                ...
                redirect('admin/pemilih/kom/','refresh');
            }
            $data = array(
                    'id_prodi' => 'kom',
        ...
        function add_pemilih($prodi=null,$smt=null,$kelas=null){
            if($prodi==null||$smt==null||$kelas==null){
                ...
                redirect('admin/kom/index/'.$prodi.'/'.$smt.'/'.$kelas);
            }		
            ...
            if($this->input->post('submit')){
                if ($this->form_validation->run() == TRUE) {
                    ...
                    if($this->ion_auth->register($username,$password,null,$additional,$group)){
                        ...
                        redirect('admin/kom/add_pemilih/'.$prodi.'/'.$smt.'/'.$kelas);
                    }
                    else{
                    ...
                    $data['kelas']		= $kelas;
                    $data['smt']		= $smt;
                    $data['content']	= 'admin/kom/add_pemilih';
                    $this->load->view('template',$data);
                }
            }
            else{
        ...
        function edit_pemilih($id=null,$prodi=null,$smt=null,$kelas=null){
            ...
            if($users_group){
                ...
                $data['kelas']		= $kelas;
                $data['smt']		= $smt;
                $data['content']	= 'admin/kom/edit_pemilih';
                $this->load->view('template',$data);
            }
            else{
                $this->session->set_flashdata('info', 'Update Failed!');
                redirect('admin/kom/edit_pemilih/'.$id.'/'.$prodi.'/'.$smt.'/'.$kelas);
            }
        }
