...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	...
	<div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel-heading">Tambah Pemilih 
                </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 col-md-8 col-md-offset-2">
                        ...
                        echo form_open('admin/tm/add_pemilih/'.$prodi.'/'.$smt.'/'.$kelas,$name);
                        ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            <input type="password" class="form-control" id="password" name="password" placeholder="Panjang Minimal 6 Karakter">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                            	<input type="submit" name="submit" class="btn btn-success btn-sm" value="Simpan">
                                    &nbsp;
                                <a href="<?php echo base_url('admin/tm/index/'.$prodi.'/'.$smt.'/'.$kelas);?>" class="btn btn-warning btn-sm"> Kembali</a>
                            </div>
                        </div>
                        </form>
                    </div>
...
<script>
	...
	function functionLock(url){
		...
		buttonsStyling: false
			...
			swal("Terhapus!", "Data berhasil dikunci!", "success");
			window.location = url;
	...
	function functionUnlock(url){
		...
		buttonsStyling: false
			...
			swal("Terhapus!", "Kunci data berhasil dibuka!", "success");
			window.location = url;
