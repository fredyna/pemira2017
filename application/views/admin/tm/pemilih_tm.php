		...
		<?php } ?>
			...
			<li class="parent ">
				...
				<ul class="children collapse in" id="data-pemilih">
					...
					<li>
						<a class="active" href="<?php echo base_url('admin/pemilih/tm/');?>">
							<i class="fa fa-chevron-circle-right" aria-hidden="true"></i>
							 D3 Teknik Mesin
						</a>
					</li>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li>Pemilih</li>
			<li class="active">D3 Teknik Mesin</li>
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">D3 Teknik Mesin</h2>
		</div>
	</div><!--/.row-->
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				...
				<?php endif; ?>
				<a href="<?php echo base_url('admin/tm/add_pemilih/'.$prodi.'/'.$smt.'/'.$kelas);?>" class="btn btn-success btn-sm btn-add"><i class="fa fa-user-plus"></i> Tambah Data</a>
				&nbsp;
				<a href="#" onclick="functionLock('<?php echo base_url('admin/tm/lockAll/'.$prodi.'/'.$smt.'/'.$kelas);?>')" class="btn btn-warning btn-sm"><i class="fa fa-lock"></i> Lock All</a>
				<a href="#" onclick="functionUnlock('<?php echo base_url('admin/tm/unlockAll/'.$prodi.'/'.$smt.'/'.$kelas);?>')" class="btn btn-info btn-sm"><i class="fa fa-unlock"></i> Unlock All</a>
							...
							<tr>
								...
								<td class="text-center">
									<?php if($data->active==0){?>
										<a href="<?php echo base_url('admin/tm/unlock/'.$data->id.'/'.$prodi.'/'.$smt.'/'.$kelas);?>" class="btn btn-info btn-xs"><i class="fa fa-lock"></i> Buka</a>
									<?php } else{?>
										<a href="<?php echo base_url('admin/tm/lock/'.$data->id.'/'.$prodi.'/'.$smt.'/'.$kelas);?>" class="btn btn-info btn-xs"><i class="fa fa-unlock"></i> Kunci</a>
									<?php }?>
									
									<a href="<?php echo base_url('admin/tm/edit_pemilih/'.$data->id.'/'.$prodi.'/'.$smt.'/'.$kelas);?>" class="btn btn-info btn-xs"><i class="fa fa-edit"></i></a>
									<a href="#" onclick="functionDelete('<?php echo base_url('admin/tm/del_pemilih/'.$data->id.'/'.$prodi.'/'.$smt.'/'.$kelas);?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							<?php }
						} else { ?>
