            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 col-md-8 col-md-offset-2">
                        ...
                        echo form_open('admin/kom/add_pemilih/'.$prodi.'/'.$smt.'/'.$kelas,$name);
                        ?>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                            	<input type="submit" name="submit" class="btn btn-success btn-sm" value="Simpan">
                                    &nbsp;
                                <a href="<?php echo base_url('admin/kom/index/'.$prodi.'/'.$smt.'/'.$kelas);?>" class="btn btn-warning btn-sm"> Kembali</a>
                            </div>
                        </div>
                        </form>
                    </div>
