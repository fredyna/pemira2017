		      ...
		      <div class="panel-body">
		      	<div class="row">
		      		<div class="col-xs-12 col-md-8 col-md-offset-2">
						...
						echo form_open('admin/ind/change_password/'.$pemilih->id.'/'.$prodi.'/'.$smt.'/'.$kelas,$name);
						?>
						  ...
						  <div class="form-group">
						    <div class="col-sm-offset-4 col-sm-8">
						      <button type="submit" class="btn btn-success btn-sm">Change</button>
									&nbsp;
									<a href="<?php echo base_url('admin/ind/index/'.$prodi.'/'.$smt.'/'.$kelas);?>" class="btn btn-warning btn-sm">Kembali</a>
						    </div>
						  </div>
						</form>
		      		</div>
		      ...
		      <div class="panel-body">
		      	<div class="row">
		      		<div class="col-xs-12 col-md-8 col-md-offset-2">
						...
						echo form_open('admin/te/change_data/'.$pemilih->id.'/'.$prodi.'/'.$smt.'/'.$kelas,$name);
						?>
						  <div class="form-group">
