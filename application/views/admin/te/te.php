			...
			<div class="panel panel-primary">
		      ...
		      <div class="panel-body">
		      	<div class="text-center">
		      		<a href="<?php echo base_url('admin/pemilih/ind/')?>" class="btn btn-warning">Industri</a> &nbsp; <a href="<?php echo base_url('admin/pemilih/dkv/')?>" class="btn btn-warning">Desain Komunikasi Visual</a> &nbsp; <a href="<?php echo base_url('admin/pemilih/tkj/')?>" class="btn btn-warning">Teknik Komputer Jaringan</a> 
		      	</div>
		      </div>
		    </div>
		</div>
