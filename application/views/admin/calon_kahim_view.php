	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				<div class="panel-heading">View Data Kahim</div>
				<div class="panel-body">
					...
					echo form_open_multipart('admin/calon/changePictureKahim/'.$calon->id,$name);
					?>
					...
					<div class="table-responsive">
						<table width="100%">
							...
							<tr>
								<td width="25%">Prodi Calon Kahim</td>
								<td width="5%">:</td>
							...
							<tr>
								<td width="25%">Misi</td>
								<td width="5%">:</td>
								<td><?php echo nl2br($calon->misi);?></td>
							</tr>
						</table>

						<br />
						<a href="<?php echo base_url('admin/calon/kahim'); ?>" class="btn btn-sm btn-warning"><i class="fa fa-arrow-left"></i> Kembali</a>	
					</div>
				</div>
			</div>
		</div>
