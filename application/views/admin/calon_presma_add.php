	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				<div class="panel-heading">Add Data Presma</div>
				<div class="panel-body">
					...
					echo form_open_multipart('admin/calon/addCalonPresma/',$name);
					?>
					 <div class="form-group">
					    <label for="no_calon" class="col-sm-4 control-label">No Calon</label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="no_calon" name="no_calon" placeholder="No Calon" value="<?php echo set_value('no_calon');?>">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="capres" name="capres" placeholder="Nama Capres" value="<?php echo set_value('capres');?>">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <select name="prodi_capres" class="form-control">
					      	<option value="" style="display: none;">--Pilih Prodi Capres--</option>
					      	<?php if($prodi!=null){ 
					      		foreach($prodi as $p){ ?>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="cawapres" name="cawapres" placeholder="Nama Cawapres" value="<?php echo set_value('cawapres');?>">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <select name="prodi_cawapres" class="form-control">
					      	<option value="" style="display: none;">--Pilih Prodi Cawapres--</option>
					      	<?php if($prodi!=null){ 
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					    	<textarea name="visi" class="form-control" placeholder="Isikan visi" value="<?php echo set_value('visi');?>"></textarea>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					    	<textarea name="misi" class="form-control" placeholder="Isikan Misi" value="<?php echo set_value('misi');?>"></textarea>
					       <?php echo form_error('misi');?>
					    </div>
					  </div>

					  <div class="form-group">
		                <label for="file1" class="col-sm-4 control-label">Gambar Capres dan Cawapres</label>
		                <div class="col-sm-8">
