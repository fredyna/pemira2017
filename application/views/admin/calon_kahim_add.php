...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Calon Kahim</li>
		</ol>
	</div><!--/.row-->        
	
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">Calon Kahim</h2>
		</div>
	</div><!--/.row-->
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				<div class="panel-heading">Add Data Calon Kahim</div>
				<div class="panel-body">
					...
					echo form_open_multipart('admin/calon/addCalonKahim/',$name);
					?>
					 <div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Calon Kahim" value="<?php echo set_value('nama');?>">
					       <?php echo form_error('nama');?>
					    </div>
					  </div>

					  <div class="form-group">
					    <label for="prodi" class="col-sm-4 control-label">Prodi Calon Kahim</label>
					    <div class="col-sm-8">
					      <select name="prodi" class="form-control">
					      	<option value="" style="display: none;">--Pilih Prodi Calon--</option>
					      	<?php if($prodi!=null){ 
					      		foreach($prodi as $p){ ?>
					  ...
					  <div class="form-group">
		                <label for="file1" class="col-sm-4 control-label">Gambar Calon Kahim</label>
		                <div class="col-sm-8">
