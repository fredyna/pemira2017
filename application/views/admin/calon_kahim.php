	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				<div class="panel-heading">Data Calon Kahim</div>
				...
				<?php endif; ?>
					...
					<a href="<?php echo base_url('admin/calon/addCalonKahim');?>" class="btn btn-success btn-sm btn-add"><i class="fa fa-user-plus"></i> Tambah Data</a>
					<div class="table-responsive">
					<?php if($calon!=null){ ?>
						<table id="cakahim" class="table table-striped table-condensed table-hover table-bordered">
					<?php } else { ?>
							...
							<?php 
								...
								<tr>
									...
									<td class="text-center">
										<a href="<?php echo base_url('admin/calon/editCalonKahim/'.$data->id);?>" class="btn btn-info btn-xs"><i class="fa fa-edit"></i></a>
										<a href="<?php echo base_url('admin/calon/viewCalonKahim/'.$data->id);?>" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
										<a href="#" onclick="functionDelete('<?php echo base_url('admin/calon/deleteCalonKahim/'.$data->id);?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
								<?php }
							} else { ?>
