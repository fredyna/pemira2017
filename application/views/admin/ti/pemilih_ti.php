...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li>Pemilih</li>
			<li class="active">D4 Teknik Informatika</li>
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">D4 Teknik Informatika</h2>
		</div>
	</div><!--/.row-->
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				...
				<?php endif; ?>
				<a href="<?php echo base_url('admin/ti/add_pemilih/'.$prodi.'/'.$smt.'/'.$kelas);?>" class="btn btn-success btn-sm btn-add"><i class="fa fa-user-plus"></i> Tambah Data</a>
				&nbsp;
				<a href="#" onclick="functionLock('<?php echo base_url('admin/ti/lockAll/'.$prodi.'/'.$smt.'/'.$kelas);?>')" class="btn btn-warning btn-sm"><i class="fa fa-lock"></i> Lock All</a>
				<a href="#" onclick="functionUnlock('<?php echo base_url('admin/ti/unlockAll/'.$prodi.'/'.$smt.'/'.$kelas);?>')" class="btn btn-info btn-sm"><i class="fa fa-unlock"></i> Unlock All</a>
							...
							<tr>
								...
								<td class="text-center">
									<?php if($data->active==0){?>
										<a href="<?php echo base_url('admin/ti/unlock/'.$data->id.'/'.$prodi.'/'.$smt.'/'.$kelas);?>" class="btn btn-info btn-xs"><i class="fa fa-lock"></i> Buka</a>
									<?php } else{?>
										<a href="<?php echo base_url('admin/ti/lock/'.$data->id.'/'.$prodi.'/'.$smt.'/'.$kelas);?>" class="btn btn-info btn-xs"><i class="fa fa-unlock"></i> Kunci</a>
									<?php }?>
									
									<a href="<?php echo base_url('admin/ti/edit_pemilih/'.$data->id.'/'.$prodi.'/'.$smt.'/'.$kelas);?>" class="btn btn-info btn-xs"><i class="fa fa-edit"></i></a>
									<a href="#" onclick="functionDelete('<?php echo base_url('admin/ti/del_pemilih/'.$data->id.'/'.$prodi.'/'.$smt.'/'.$kelas);?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							<?php }
						} else { ?>
