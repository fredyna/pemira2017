...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">D4 Teknik Informatika</h1>
		</div>
		      ...
		      <div class="panel-body">
		      	<div class="row">
		      		...
		      		<?php if($this->session->flashdata('info')): ?>
						...
						echo form_open('admin/ti/addKelas',$name);
						?>
				    	...
				    	<div class="panel-body">
							<?php 
				    			...
				    			if($jml==0){
				    				...
				    				for($i=0;$i<$jml;$i++){?>
				    				<a href="<?php echo base_url('admin/ti/index/ti/1/'.$kelas[$i]);?>" class="btn btn-info"><?php echo 'Kelas '.$kelas[$i];?></a>
				    				<br>
				    		<?php } 
				    			} ?>
				    	</div>
				    	...
				    	<div class="panel-body">
				    		<?php 
				    			...
				    			if($jml==0){
				    				...
				    				for($i=0;$i<$jml;$i++){?>
				    				<a href="<?php echo base_url('admin/ti/index/ti/3/'.$kelas[$i]);?>" class="btn btn-info"><?php echo 'Kelas '.$kelas[$i];?></a>
				    				<br>
				    		<?php } 
				    			} ?>
				    	</div>
				    	...
				    	<div class="panel-body">
				    		<?php 
				    			...
				    			if($jml==0){
				    				...
				    				for($i=0;$i<$jml;$i++){?>
				    				<a href="<?php echo base_url('admin/ti/index/ti/5/'.$kelas[$i]);?>" class="btn btn-info" style="color:#fff;display:block;text-align:center;"><?php echo 'Kelas '.$kelas[$i];?></a>
				    				<br>
				    		<?php } 
				    			} ?>
				    	</div>
				    	...
				    	<div class="panel-body">
				    		<?php
				    			...
				    			if($jml==0){
				    				...
				    				for($i=0;$i<$jml;$i++){?>
				    				<a href="<?php echo base_url('admin/ti/index/ti/7/'.$kelas[$i]);?>" class="btn btn-info" style="color:#fff;display:block;text-align:center;"><?php echo 'Kelas '.$kelas[$i];?></a>
				    				<br>
				    		<?php } 
				    			} ?>
				    	</div>
