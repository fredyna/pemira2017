	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				<div class="panel-heading">Data Calon Presma</div>
				...
				<a href="<?php echo base_url('admin/calon/addCalonPresma');?>" class="btn btn-success btn-sm btn-add"><i class="fa fa-user-plus"></i> Tambah Data</a>
					...
					<table class="table table-striped table-condensed table-hover table-bordered">
						...
						<?php 
							...
							<tr>
								...
								<td><?php echo $data->nama_pres;?></td>
								<td><?php echo $data->nama_wapres;?></td>
								<td class="text-center">
									<a href="<?php echo base_url('admin/calon/editCalonPresma/'.$data->id);?>" class="btn btn-info btn-xs"><i class="fa fa-edit"></i></a>
									<a href="<?php echo base_url('admin/calon/viewCalonPresma/'.$data->id);?>" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
									<a href="#" onclick="functionDelete('<?php echo base_url('admin/calon/deleteCalonPresma/'.$data->id);?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							<?php }
						} else { ?>
