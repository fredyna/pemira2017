...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	...
	<ul class="nav menu">
		...
		<li class="active"><a href="<?php echo base_url('admin/c_admin/settings');?>"><i class="fa fa-cog"></i> Settings</a></li>	
		...
		<div class="col-lg-12">
			<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						echo form_open('admin/c_admin/change_password/'.$user->id,$name);
						?>
		...
		<div class="col-lg-12">
			<div class="panel panel-info">
					...
					<div class="panel-body">
						...
						echo form_open('admin/c_admin/change_data/'.$user->id,$name);
						?>
							<div class="form-group">
